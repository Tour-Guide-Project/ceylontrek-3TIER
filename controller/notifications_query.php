...
if(isset($_POST['str']) && isset($_SESSION['id'])){
    ...
    $sql = "SELECT * FROM notifications WHERE notification_level='tourist' AND user_id='{$user_id}' ORDER BY seen_state ASC;";
    $result_set = mysqli_query($connection,$sql);
    //print_r($result_set);
    $sql2 = "SELECT * FROM notifications WHERE notification_level='tourist' AND user_id='{$user_id}' AND seen_state=0";
