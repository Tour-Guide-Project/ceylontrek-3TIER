...
if(isset($_GET['id'])){
    ...
    if($result_set2){
        ...
        header('Location:/ceylontrek-3tier/view/full_complain_view_admin.php?view_complain='.$view_records.'');
    }    
}
 ...
 if(isset($_GET['checked_id'])){
    ...
    $result_set3=delete_checked_complain($connection,$checked_id);
