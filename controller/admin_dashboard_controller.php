...
if (isset($_POST['submit_guide'])) {
	header('Location: ../controller/view_users_admin_controller.php?user_level=tourguide');
}
if (isset($_POST['submit_tourist'])) {
	header('Location: ../controller/view_users_admin_controller.php?user_level=tourist');
}
