...
<body style="background:none;">
	...
	<div class="complains_box">
		...
		<form action="../controller/complains_controller.php" method="post">
			...
			<div class="text_box">
				...
				proident, sunt in culpa qui officia deserunt mollit anim id est laborum.<button type="submit" name="view_more">View More &raquo;</button></p>
			</div>
			<div class="text_box">
				<p><h2>Title</h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
				tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
