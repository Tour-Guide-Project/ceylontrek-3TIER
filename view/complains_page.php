			...
			<?php 
			    if(isset($_GET['complaint'])){
					...
					foreach ($records as $record) { ?>
						<?php if($record['report_status']==1){?>
							<div class="text_box" style="background-color: rgb(178, 185, 226);border-color: rgb(56, 15, 15);opacity:0.8;">
						...
						<?php }elseif($record['checked_status']==1){?>
